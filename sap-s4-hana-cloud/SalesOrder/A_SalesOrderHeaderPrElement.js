...
var A_SalesOrderHeaderPrElementEntityBuilder = require("sap-s4-hana-cloud/SalesOrder/Builders/A_SalesOrderHeaderPrElementEntityBuilder");
...
exports.entityBuilder = function() {
	return new A_SalesOrderHeaderPrElementEntityBuilder();
};

exports.getClient = function(configurations) {
	return new A_SalesOrderHeaderPrElementClient(configurations);
};

function A_SalesOrderHeaderPrElementClient (configurations) {

	var API_PATH = "/sap/opu/odata/sap/API_SALES_ORDER_SRV/A_SalesOrderHeaderPrElement";
